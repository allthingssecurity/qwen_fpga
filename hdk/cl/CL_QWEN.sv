...
//=============================================================================
// OCL  -> qwen_matvec_engine (int8 matvec datapath, host-driven over AXI-Lite)
//=============================================================================

  qwen_matvec_engine #(.IN_MAX(1024), .OUT_MAX(64), .LANES(4)) u_engine (
    .clk       (clk_main_a0),
    .rst_n     (rst_main_n),
